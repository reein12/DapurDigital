...
<nav class="navbar navbar-expand-lg sticky-top bg-white shadow">
    <div class="container">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarScroll"
            ...
            <img src="images/hamburger.png" alt="Menu" class="hamburger-icon">
        </button>
    ...
    <section id="Fitur" class="fitur">
        <div class="container py-5">
            <div class="row pt-5 align-items-center text-center">
                <div class="col-lg-3">
                    <img src="images/traditional.jpg" class="img-fluid custom-img" alt="Meals" onclick="toggleMeals()">
                    <h6>Meals</h6>
                </div>
                <div class="col-lg-3">
                    <img src="images/pasta.jpg" class="img-fluid custom-img" alt="Snack" onclick="toggleMeals()">
                    <h6>Snack</h6>
                </div>
                <div class="col-lg-3">
                    <img src="images/drink.jpg" class="img-fluid custom-img" alt="Dessert" onclick="toggleMeals()">
                    <h6>Dessert</h6>
                </div>
                <div class="col-lg-3">
                    <img src="images/dessertt.jpg" class="img-fluid custom-img" alt="Drink" onclick="toggleMeals()">
                    <h6>Drink</h6>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-3 text-center">
                        <div class="card border-0 bg-light mb-2">
                            <div class="card-body">
                                <img src="images/nasgor.jpg" class="img-resep" alt="">
                            </div>
                        </div>
                        <h6><strong>Nasi Goreng Kampung</strong></h6>
                        <p>Ratings</p>
                    </div>
                    <div class="col-lg-3 text-center">
                        <div class="card border-0 bg-light mb-2">
                            <div class="card-body">
                                <img src="images/carbonara.jpg" class="img-resep" alt="">
                            </div>
                        </div>
                        <h6><strong>Pasta Carbonara</strong></h6>
                        <p>Ratings</p>
                    </div>
                    <div class="col-lg-3 text-center">
                        <div class="card border-0 bg-light mb-2">
                            <div class="card-body">
                                <img src="images/cheesecake.jpg" class="img-resep" alt="">
                            </div>
                        </div>
                        <h6><strong>Cheesecake Strawberry</strong></h6>
                        <p>Ratings</p>
                    </div>
                    <div class="col-lg-3 text-center">
                        <div class="card border-0 bg-light mb-2">
                            <div class="card-body">
                                <img src="images/smoothies.jpg" class="img-resep" alt="">
                            </div>
                        </div>
                        <h6><strong>Banana Smoothies</strong></h6>
                        <p>Ratings</p>
                    </div>
                </div>
                <div class="row py-5">
                    <div class="col-12 text-center">
                        <a href="tambah_resep/tambah_resep.php">
                            <button class="btn">My Recipe</button>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <section id="About" class="about-section">
        <div class="container py-5">
            <div class="row py-5">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <img src="images/cowoku.jpg" class="img-fluid equal-img mb-3">
                    ...
                    <div class="col-lg-6">
                        <img src="images/cewe.jpg" class="img-fluid equal-img mb-3">
                        <h5>Lee Ji-eun</h5>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="social-icons d-flex justify-content-center gap-3">
                                <a href="https://www.instagram.com" target="_blank">
                                    <img src="images/instagram (1).png" alt="Instagram" width="40">
                                </a>
                                ...
                                <a href="https://wa.me/yourphonenumber" target="_blank">
                                    <img src="images/social.png" alt="WhatsApp" width="40">
                                </a>
                            </div>
                        </div>
                    </div>
